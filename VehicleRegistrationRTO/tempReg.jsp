...
ArrayList<DealerBean> db=DealerDao.displayNewBooking();
...
<tr>
	...
	<td width="43" align="center"><div align="center" ><span style="font-size: 14"><%=it.getVtype()%> </span></div></td>
	 <td width="43" align="center"><div align="center" ><span style="font-size: 14"><a href="tempRegAction.jsp?id=<%=it.getId() %>">Approve</a> </span></div></td>
