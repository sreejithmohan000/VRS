...
<%
ArrayList<AdminBean> ab=AdminDao.viewDealer();
			...
			<td width="43" align="center"><div align="center" ><span style="font-size: 14"><%=it.getMob()%></span></div></td>
				<td width="43" align="center"><div align="center" ><span style="font-size: 14"><%=it.getEmail()%></span></div></td>
					<td width="43" align="center"><div align="center" ><span style="font-size: 14"><%=it.getUname()%></span></div></td>
						<td width="43" align="center"><div align="center" ><span style="font-size: 14"><a href="dealerDelete.jsp?&dusername=<%=it.getUname()%>">DELETE</a></span></div></td>
	<td width="43" align="center"><div align="center" ><span style="font-size: 14"><a href="dealerUpdate.jsp?dname=<%=it.getName()%>&daddress=<%=it.getAddress()%>&didproof=<%=it.getIdproof()%>&didproofno=<%=it.getIdproofno()%>&dmob=<%=it.getMob()%>&demail=<%=it.getEmail()%>&dusername=<%=it.getUname()%>">UPDATE</a></span></div></td>
	</tr>
